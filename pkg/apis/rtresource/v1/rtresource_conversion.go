...
func (source *RTResource) ConvertTo(_ context.Context, sink apis.Convertible) error {
	return fmt.Errorf("v1 is the highest known version, got: %T", sink)
}

// ConvertFrom implements apis.Convertible
func (sink *RTResource) ConvertFrom(_ context.Context, source apis.Convertible) error {
