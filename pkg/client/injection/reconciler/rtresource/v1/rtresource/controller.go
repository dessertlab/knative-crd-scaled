...
import (
	...
	rtresource "knative.dev/serving/pkg/client/injection/informers/rtresource/v1/rtresource"
)

const (
	defaultControllerAgentName = "rtresource-controller"
	defaultFinalizerName       = "rtresources.rtresource.example.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rtresourceInformer := rtresource.Get(ctx)

	lister := rtresourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "rtresource.example.com.RTResource"),
	)
